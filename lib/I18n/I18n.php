 ...
 */
	public static function translate($singular, $domain = null, $plural = null, $category = self::LC_MESSAGES, $count = null, $language = null) {
 ...
 */
	protected function _bindTextDomain($domain) {
		...
		$core = true;
		$merge = array();
		$searchPaths = array(App::$ROOT . DS . "app" . DS . "locale" . DS);
